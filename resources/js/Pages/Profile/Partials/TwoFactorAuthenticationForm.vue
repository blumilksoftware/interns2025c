...
const regenerateRecoveryCodes = () => {
  axios
    ...
    .catch(error => {
      console.error('Recovery codes regeneration failed')
      throw error
    })
}
    ...
    <template #content>
      ...
      <div v-if="twoFactorEnabled">
        ...
        <div v-if="recoveryCodes.length > 0 && ! confirming">
          ...
          <div class="grid gap-1 max-w-xl mt-4 p-4 font-mono text-sm bg-gray-100 dark:bg-gray-900 dark:text-gray-100 rounded-lg">
