  ...
  <div class="relative py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="mx-auto max-w-2xl text-center">
        <h1 class="text-4xl font-semibold tracking-tight text-balance text-gray-900 leading-15 sm:text-5xl">{{ t('landing.imageSection.title') }}</h1>
        <h2 class="mt-2 text-lg/8 text-gray-600">{{ t('landing.imageSection.subtitle') }}</h2>
      </div>
