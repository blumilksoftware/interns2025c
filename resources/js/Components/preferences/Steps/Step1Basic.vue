    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="filter-item transition-all duration-200 ease-in-out" data-filter-id="age">
        <div class="flex items-center justify-between mb-3">
          ...
          <button type="button" class="text-xs px-2 py-1 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out" @click="form.ageIndex = []; moveFilterById('age')">{{ t('preferences.placeholders.any') }}</button>
        </div>
      ...
      <div class="filter-item" data-filter-id="size">
        <div class="flex items-center justify-between mb-3">
          ...
          <button type="button" class="text-xs px-2 py-1 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out" @click="form.sizeIndex = []; moveFilterById('size')">{{ t('preferences.placeholders.any') }}</button>
        </div>
      ...
      <div class="filter-item" data-filter-id="weight">
        <div class="flex items-center justify-between mb-3">
          ...
          <button type="button" class="text-xs px-2 py-1 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out" @click="form.weightState = []; moveFilterById('weight')">{{ t('preferences.placeholders.any') }}</button>
        </div>
