...
<template>
  <main role="main">
    <div class="bg-white/70 backdrop-blur-md border border-gray-200/60 rounded-xl p-4 filter-item transition-all duration-200 ease-in-outhover:shadow-lg" data-filter-id="attitudes">
      <div class="flex items-center justify-between mb-4">
        <span class="block text-base font-medium text-gray-800">{{ t('preferences.attitudes') }}</span>
      </div>
      <div class="grid grid-cols-1 md:auto-rows-fr gap-6">
        <div class="h-full border border-gray-200/70 rounded-lg p-3 bg-white/60 filter-item" data-filter-id="attitude-dogs">
          <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-600">{{ t('preferences.labels.attitudeToDogs') }}</span>
            <button type="button" :aria-label="t('preferences.labels.attitudeToDogs') + ': ' + t('preferences.placeholders.any')" class="text-[11px] px-2 py-0.5 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out" @click="form.attitudeToDogs = null; props.moveFilterById('attitude-dogs')">{{ t('preferences.placeholders.any') }}</button>
          </div>
        ...
        <div class="h-full border border-gray-200/70 rounded-lg p-3 bg-white/60 filter-item" data-filter-id="attitude-cats">
          <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-600">{{ t('preferences.labels.attitudeToCats') }}</span>
            <button type="button" :aria-label="t('preferences.labels.attitudeToCats') + ': ' + t('preferences.placeholders.any')" class="text-[11px] px-2 py-0.5 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out  " @click="form.attitudeToCats = null; props.moveFilterById('attitude-cats')">{{ t('preferences.placeholders.any') }}</button>
          </div>
        ...
        <div class="h-full border border-gray-200/70 rounded-lg p-3 bg-white/60 filter-item" data-filter-id="attitude-children">
          <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-600">{{ t('preferences.labels.attitudeToChildren') }}</span>
            <button type="button" :aria-label="t('preferences.labels.attitudeToChildren') + ': ' + t('preferences.placeholders.any')" class="text-[11px] px-2 py-0.5 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out hover: -translate-y-0.5" @click="form.attitudeToChildren = null; props.moveFilterById('attitude-children')">{{ t('preferences.placeholders.any') }}</button>
          </div>
        ...
        <div class="h-full border border-gray-200/70 rounded-lg p-3 bg-white/60 filter-item" data-filter-id="attitude-adults">
          <div class="flex items-center justify-between mb-2">
            <span class="text-xs font-medium text-gray-600">{{ t('preferences.labels.attitudeToAdults') }}</span>
            <button type="button" :aria-label="t('preferences.labels.attitudeToAdults') + ': ' + t('preferences.placeholders.any')" class="text-[11px] px-2 py-0.5 rounded-md border border-gray-300 text-gray-700 hover:bg-gray-100 transition-all cursor-pointer duration-150 ease-in-out" @click="form.attitudeToAdults = null; props.moveFilterById('attitude-adults')">{{ t('preferences.placeholders.any') }}</button>
          </div>
